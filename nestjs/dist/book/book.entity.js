...
__decorate([
    sequelize_typescript_1.ForeignKey(() => writer_entity_1.Writer),
    __metadata("design:type", Number)
], Book.prototype, "authorId", void 0);
__decorate([
    sequelize_typescript_1.BelongsTo(() => writer_entity_1.Writer, 'authorId'),
...
Book = __decorate([
    sequelize_typescript_1.Table({ tableName: 'books' })
], Book);
exports.Book = Book;
